  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-3">
        <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-primary/15 text-primary shadow-[0_4px_14px_-4px_rgba(30,107,168,0.6)] transition-all group-hover:scale-105 group-hover:bg-primary group-hover:text-white group-hover:shadow-[0_6px_20px_-4px_rgba(30,107,168,0.8)]">
