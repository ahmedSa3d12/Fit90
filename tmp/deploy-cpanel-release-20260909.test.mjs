...
const release = new URL('../release/FIT90-FULL-update-20260909/', import.meta.url);
const script = new URL('deploy-cpanel.sh', release);
const rootHandoff = new URL('ROOT-PM2-COMMAND.txt', release);

test('the 20260909 cPanel deployment script does not mutate the database or PM2', () => {
...
test('the root handoff owns the PM2 restart', () => {
