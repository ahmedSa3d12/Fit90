...
const release = new URL('../release/FIT90-FULL-update-20260906-r3/', import.meta.url);
const script = new URL('deploy-cpanel.sh', release);
const rootHandoff = new URL('ROOT-PM2-COMMAND.txt', release);

test('r3 includes the non-root cPanel deployment script without database mutation', () => {
...
test('r3 delegates only the process restart to root', () => {
