...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // FIT90 brand scale — energetic red gradient.
        brand: {
          50: '#FDF2F2',
          100: '#FBE4E4',
          200: '#F5C6C7',
      ...
      backgroundImage: {
        'brand-gradient': 'linear-gradient(135deg, #681719 0%, #C0252B 55%, #D76364 100%)',
        'brand-gradient-soft': 'linear-gradient(135deg, #741519 0%, #C0252B 60%, #D76364 100%)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
