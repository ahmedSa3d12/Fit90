...
export function ListStatusTabs({ tabs, paramKey = 'status', defaultValue = '', className, buttonClassName }: ListStatusTabsProps) {
        ...
        return (
          <button
            ...
            className={cn(
              ...
              buttonClassName,
              active
                ? 'bg-background font-semibold text-foreground shadow-sm dark:bg-white/[0.12] dark:text-foreground dark:shadow-none'
            ...
            {tab.count != null && (
              <span
                className={cn(
                  ...
                  active
                    ? 'bg-primary/15 text-primary dark:bg-white/[0.15] dark:text-[#E7EFF7]'
