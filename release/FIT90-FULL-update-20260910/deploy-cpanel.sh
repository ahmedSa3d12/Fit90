...
echo "==> [2/4] Copying backend source (.env, uploads, node_modules, and database are untouched)"
...
# Nest currently emits the application entry point at dist/src/main.js.
# Do not report a successful deploy unless the PM2 startup file exists.
