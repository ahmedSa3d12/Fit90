...
export function DataTable<T>({
  ...
  const { canExport, canPrint } = useOutputPermissions();
  ...
  const canShowOutput = enableExport && data.length > 0 && (canExport || canPrint);
  const hasToolbar = !!(onSearchChange || toolbar || canShowOutput);
