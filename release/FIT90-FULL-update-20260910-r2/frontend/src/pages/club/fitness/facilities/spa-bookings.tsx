...
export function FitnessSpaBookingsPage() {
  ...
  const openEdit = (row: ClubSpaBookingRow) => {
    ...
    if (row.memberId != null) {
      void api
        .get<ClubMemberListItem>(`/club-members/${row.memberId}`)
          ...
          <div className="grid gap-3 py-2">
            <div className="grid gap-2">
              ...
              <MemberSearchCombobox
                ...
                onClear={() => {
                  setSelectedMember(null);
                  setForm((f) => ({ ...f, memberId: '', customerName: '', customerPhone: '' }));
                }}
                disabled={saving}
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="grid gap-2">
                ...
                <Input type="time" className="nums" value={form.bookingTime} onChange={(e) => setForm((f) => ({ ...f, bookingTime: e.target.value }))} />
              </div>
            </div>
            <div className="grid gap-2">
