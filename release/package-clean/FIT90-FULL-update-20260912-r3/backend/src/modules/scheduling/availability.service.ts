...
export class AvailabilityService {
  ...
  async nutritionAvailableTimes(
    ...
    return this.providerAvailableTimes(serviceId, trainerId, date, 'nutrition', branchId);
  }

  async providerAvailableTimes(
    serviceId: number,
    trainerId: number,
    date: string,
    ...
    if (!service) throw new NotFoundException(`${category} service not found.`);
