...
@Module({
  ...
  providers: [MenuService, WorkspaceService, WorkspaceWidgetsService, TrainerDashboardService, StaffDashboardsService, PermissionCacheService, PermissionEngineService],
  exports: [MenuService, WorkspaceService, WorkspaceWidgetsService, TrainerDashboardService, StaffDashboardsService, PermissionCacheService, PermissionEngineService],
})
