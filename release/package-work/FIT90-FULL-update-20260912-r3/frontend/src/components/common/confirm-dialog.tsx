            ...
            <table className="w-full">
              <thead>
                <tr className="border-b bg-muted/50">
                  <th className="px-3 py-2 text-start font-medium">{t('shared.field') ?? 'الحقل'}</th>
                  <th className="px-3 py-2 text-start font-medium">{t('shared.before') ?? 'قبل'}</th>
                  <th className="px-3 py-2 text-start font-medium">{t('shared.after') ?? 'بعد'}</th>
                </tr>
              </thead>
              <tbody>
