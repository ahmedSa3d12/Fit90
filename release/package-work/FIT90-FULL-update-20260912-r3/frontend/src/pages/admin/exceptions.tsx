...
import { rbacRoleName, unsavedChangesHint } from '@/lib/rbac-labels';
          ...
          <Card className="overflow-hidden">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border bg-muted/30 px-4 py-2">
              <p className="text-xs text-muted-foreground">
                ...
                {dirty && <span className="font-semibold text-primary">{unsavedChangesHint(changes.length, locale, ui)}</span>}
              </p>
