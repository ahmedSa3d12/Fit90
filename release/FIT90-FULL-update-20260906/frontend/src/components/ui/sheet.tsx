...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-card p-6 shadow-lg transition ease-in-out data-[state=open]:animate-slide-up data-[state=closed]:duration-200 data-[state=open]:duration-300',
  {
    variants: {
      side: {
