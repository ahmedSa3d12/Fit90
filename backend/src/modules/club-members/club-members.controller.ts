...
export class ClubMembersController {
  ...
  @Get('potential-lead')
  potentialLead(@Query('phone') phone?: string) {
    return this.service.findPotentialLeadByPhone(phone);
  }
  ...
  @Post('from-potential/:leadId')
  @RequiresPermission('club.members:create')
  createFromPotentialLead(
    @Param('leadId', ParseIntPipe) leadId: number,
    @Body() body: UpsertClubMemberDto,
    @CurrentUser() user: JwtUser,
  ) {
    return this.service.createFromPotentialLead(leadId, body, user);
  }
